...
const radiusPresets = [
  ...
  { name: "Subtle", values: { topLeft: 4, topRight: 4, bottomRight: 4, bottomLeft: 4 } },
  ...
  { name: "Top Only", values: { topLeft: 8, topRight: 8, bottomRight: 0, bottomLeft: 0 } },
  { name: "Circle", values: { topLeft: 50, topRight: 50, bottomRight: 50, bottomLeft: 50 } },
  { name: "Organic", values: { topLeft: 12, topRight: 24, bottomRight: 8, bottomLeft: 20 } },
  { name: "Tab Shape", values: { topLeft: 8, topRight: 8, bottomRight: 0, bottomLeft: 0 } },
  { name: "Ticket", values: { topLeft: 0, topRight: 12, bottomRight: 12, bottomLeft: 0 } },
];
...
export function BorderRadiusScreen() {
  ...
  const updateRadius = (corner: keyof Pick<BorderRadiusConfig, 'topLeft' | 'topRight' | 'bottomRight' | 'bottomLeft'>, value: number) => {
    if (config.linked) {
      setConfig(prev => ({
        ...prev,
        topLeft: value,
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-3">
          ...
          <span className="text-xs text-muted">
            {config.linked ? "Linked - all corners update together" : "Individual corner control"}
          </span>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="aspect-square bg-surface-1 border border-border rounded-lg p-4 relative">
            <div className="text-center text-xs text-muted mb-2">Visual Guide</div>
          ...
          <div className="space-y-3">
            <div>
              <label className="block text-xs font-medium mb-1">
                Top Left: {config.topLeft}{config.unit}
              </label>
              <Input
                type="number"
            ...
            <div>
              <label className="block text-xs font-medium mb-1">
                Top Right: {config.topRight}{config.unit}
              </label>
              <Input
                type="number"
            ...
            <div>
              <label className="block text-xs font-medium mb-1">
                Bottom Right: {config.bottomRight}{config.unit}
              </label>
              <Input
                type="number"
            ...
            <div>
              <label className="block text-xs font-medium mb-1">
                Bottom Left: {config.bottomLeft}{config.unit}
              </label>
              <Input
                type="number"
